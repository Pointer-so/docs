...
1 chat message is equivalent to 1 credit. This is usually for simple question-answer interactions.

For example, a question like "What's the purpose of this function?" would typically be 1 credit.

### Guides

1 guide is equivalent to 4 credits. This is for more complex questions that require a more detailed explanation.

Most guides are usually 4-5 steps, but it can vary. This would cost roughly 4 credits.

For more complex guides, cost may be higher.
