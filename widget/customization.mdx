...
<PointerProvider
  ...
  avatars={[                                    // Avatars (max 3)
    "https://your-company.com/avatar1.png",
    "https://your-company.com/avatar2.png",
    "https://your-company.com/avatar3.png"
  ]}
  triggerIcon="sparkles"                       // Widget trigger icon
>
```

Examples of `avatars` include headshots of your founding team, customer support team, or any other team members. We recommend using a minimum of 2 avatars, and a maximum of 3. 

All `avatars` and your `logomark` should be links.
