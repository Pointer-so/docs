...
<Warning>
  **Deprecated**: This method of styling through code is deprecated. Please use the Pointer dashboard's Playground for all customization and styling. The Playground provides a more user-friendly interface and ensures compatibility with future updates.
</Warning>
...
![images/styling.png](/images/styling.png)

For the `PointerFlowProvider`:

![styling-onboarding.png](/styling-onboarding.png)

For both providers (steps):

![images/step-styling.png](/images/step-styling.png)
