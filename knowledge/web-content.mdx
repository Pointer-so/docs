...
Content from URLs can change over time. We automatically rescrape your URLs weekly to keep content fresh. You can also trigger manual rescrapes if content changes sooner, with a 5-minute cooldown between rescrapes.&#x20;
