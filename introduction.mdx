...
To get started, check out our [Quickstart](https://docs.pointer.so/quickstart) guide. If you want a .txt version of our docs to paste into an LLM, visit our [/llms-full.txt page](https://docs.pointer.so/llms-full.txt). 
